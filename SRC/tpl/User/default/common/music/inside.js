...
G.logic.page = {
    ...
    common: function () {
        ...
        if ($daterangepick.length > 0) { 
            ...
            $daterangepick.next("span.add-on").on("click", function () {
                $daterangepick.trigger("click");
            });
        } 
...
G.util.select = function (options) {
    ...
    function _fill(n, t, i) {
        ...
        e = 1;
        u = 0;
        for (f in r) s = r[f], o = "", f == i && (u = e, o = 'selected="selected"'), h = $('<option value="' + f + '" ' + o + ">" + s + "<\/option>"), n.append(h), e++;
